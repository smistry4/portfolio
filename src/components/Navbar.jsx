...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-center items-center w-full h-20 text-white bg-black absolute px-4'>
      <ul className='hidden md:flex'>
        {links.map(({ id, link }) => (
          <li key={id} className="px-4 cursor-pointer capitalize font-large text-gray-500 hover:scale-105 duration-200">
